...
def startComputeChains(imageHeight,imageWidth,imageDepth,
        imageDx,imageDy,imageDz,
...
def runComputation(imageDx,imageDy,imageDz, coloridx,calculateout,
        V,FV, input_pkl_file, best_slice, BORDER_FILE, DIR_O):
...
def main(argv):
	...
	print 'imDx', imageDx, imageDy, imageDz
        print 'colors', colors, coloridx
        print 'calc', calculateout
        print 'V.len: ', len(V), ' V[0:4]: ', V[0:4]
        print 'FV.len: ', len(FV), 'FV[0:4]: ', FV[0:4]
        print 'dirl', DIR_IN, BEST_IMAGE, BORDER_FILE
        print 'diro ', DIR_O
        runComputation(imageDx, imageDy, imageDz, coloridx, calculateout, V, FV, DIR_IN, BEST_IMAGE, BORDER_FILE, DIR_O)
